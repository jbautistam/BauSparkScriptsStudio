...
namespace Bau.Libraries.LibCsvFiles
{
	...
	public class CsvReader : IDataReader
	{
		...
		private string ReadLine()
		{
			string line = string.Empty;
				...
				while (!FileReader.EndOfStream && string.IsNullOrWhiteSpace(line))
				{
					...
					// Para la primera línea, se salta las cabeceras
					if (_row == 0)
					{
		...
		{
			return Columns.Count == 0 || FileDefinition.TypedHeader || FileDefinition.SkipFirstLine;
		}
		...
		/// </summary>
		private void ParseFileHeaders(string line)
		{
